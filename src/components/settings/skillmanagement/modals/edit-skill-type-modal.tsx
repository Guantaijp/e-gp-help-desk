...
import { AddTrainingRequirementModal } from "./add-training-requirement-modal"
import type { SkillType, TrainingRequirement } from "../../../../types/skill-management"

interface EditSkillTypeModalProps {
    isOpen: boolean
    onClose: () => void
...
export function EditSkillTypeModal({ isOpen, onClose, onSubmit, skillType }: EditSkillTypeModalProps) {
    ...
    useEffect(() => {
        if (skillType) {
            setFormData({
                ...
                trainingLevel: skillType.trainingLevel,
                tags: skillType.tags.join(", "),
            })
            // Note: You might need to fetch training requirements for this skill type
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    <DialogTitle>Edit Skill Type</DialogTitle>
                </DialogHeader>
